...
} from "../../../../../infrastructure/persistence/repositories/MongoDBCustomerRepository";
...
describe("MongoDBCustomerRepository", () => {
    ...
    it("should find a customer by ID", async () => {
        ...
        await expect(
            ValidationUtils.validateCustomerExists(foundCustomer.getId(), mongoDBCustomerRepository)
